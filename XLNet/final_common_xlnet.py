...
from config import  pre_trained_model_name, num_epochs, batch_size, lr, device, false_num, val_fine_tuned_epo, length_sentence_A, model_type, model_name, TEST_BATCH_SIZE
...
class xlnet_model():
    ...
    def fit_and_train(self, train_df, val_df, val_train_df, require_grad):
        ...
        model = XLNetForSequenceClassification.from_pretrained(pre_trained_model_name, num_labels = NUM_LABELS)
